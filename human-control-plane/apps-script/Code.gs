...
const CAREER_OPS_SYSTEM_HEADERS = Object.freeze({
  ...
  PIPELINE: ['Pipeline Rank','Company','Role','Recommendation','Candidate Fit','Opportunity Quality','Evidence Confidence','Location','Employment Model','State','Final Priority','Why This Role','Freshness','Source','Decision Outcome','Enrichment Status','Last Updated','Job URL','Admission Reason','Policy Version','Entity ID','Projection Hash'],

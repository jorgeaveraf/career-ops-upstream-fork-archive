...
export const TAB_CONTRACTS = Object.freeze({
  ...
  PIPELINE: tab('Entity ID', ['State', 'Current Rank', 'Company', 'Role', 'Eligibility', 'Selection Score', 'Final Priority', 'Attention Status', 'Evidence Confidence', 'Research Needs', 'Freshness', 'Source', 'Human Decision', 'Rejection Reason', 'Decision Outcome', 'Enrichment Status', 'Last Updated', 'Job URL', 'Entity ID', 'Projection Hash'], ['Human Decision', 'Rejection Reason']),
  ...
  SOURCE_METRICS: tab('Metric ID', ['Scope', 'Source', 'Strategy', 'Discovered', 'Valid', 'Duplicates', 'Eligible', 'Shortlist', 'Evaluated', 'Package Ready', 'Provider ROI', 'Evaluation ROI', 'Last Run', 'Metric ID']),
});

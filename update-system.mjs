...
const SYSTEM_PATHS = [
  ...
  'backup.mjs',
  'launch-agent.mjs',
  'browser-launch-agent.mjs',
  'browser-research.mjs',
  'discovery-strategy.mjs',
  'job-registry.mjs',
  'opportunity-funnel.mjs',
  'candidate-kb.mjs',
  'deep-evaluate.mjs',
  'application-package.mjs',
  'contact-intelligence.mjs',
  'human-control-plane.mjs',
  'facebook.mjs',
  'application-activation.mjs',
  'application-activation/',
  'application-enrich.mjs',
  'application-enrichment-launch-agent.mjs',
  'application-enrichment/',
  'application-execution.mjs',
  'application-execution/',
  'artifact-access-launch-agent.mjs',
  'artifact-access.mjs',
  'artifact-access/',
  'candidate-gmail-auth.mjs',
  'candidate-selection/',
  'candidate-set.mjs',
  'command-subscriber-launch-agent.mjs',
  'command-subscriber.mjs',
  'eligibility-repair.mjs',
  'enrichment-queue.mjs',
  'execution-orchestration/',
  'execution-worker-launch-agents.mjs',
  'feedback-calibration.mjs',
  ...
  'services/',
  'timeline.mjs',
  'today-diagnostics.mjs',
  'pipeline-diagnostics.mjs',
  'workflow-events/',
  'workflow-status/',
  'backups/.gitkeep',
  'logs/.gitkeep',
  'logs/browser/.gitkeep',
  'logs/browser/discovery/.gitkeep',
  'config/browser-research.example.json',
  'acquisition/',
  'candidate-knowledge/',
  'discovery-strategy/',
  'deep-evaluation/',
